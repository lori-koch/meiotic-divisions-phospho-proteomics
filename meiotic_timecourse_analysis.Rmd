...
# setwd("/Users/lkoch/Documents/Github scripts/2023 paper/stuff")
# getwd()
...
# there are 20 sites that still have two positions listed
# strip to only first
WT.phos.fin.df$gene.name_site <- strsplit.extract(WT.phos.fin.df$gene.name_site, ";",1)

WT.phos.fin.df$Positions.within.proteins <- strsplit.extract(WT.phos.fin.df$Positions.within.proteins, ";",1)
...
saveRDS(WT.protg.fin.df,"WT_protg.RDS")
saveRDS(WT.phos.fin.df,"WT_phos.RDS")
saveRDS(WT.spo13.protg.fin.df,"WT_spo13_protg.RDS")
saveRDS(WT.spo13.phos.fin.df,"WT_spo13_phos.RDS")
